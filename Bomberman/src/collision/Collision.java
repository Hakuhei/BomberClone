...
public class Collision {
	...
	public static boolean flameCollision(int x, int y, Arena level) {
		boolean up = true, down = true, right = true, left = true;
		
		for(int i = 0; i < Arena.flame.size(); i++) {
			for(int f = 1; f <= Arena.flame.get(i).getRange(); f++)	 {
				
				int flameX0 = Arena.flame.get(i).getX();
				int flameY0 = Arena.flame.get(i).getY();
				int flameX1 = Arena.flame.get(i).getX() + (64 * f);
				int flameY1 = Arena.flame.get(i).getY();
				int flameX2 = Arena.flame.get(i).getX() - (64 * f);
				int flameY2 = Arena.flame.get(i).getY();
				int flameX3 = Arena.flame.get(i).getX();
				int flameY3 = Arena.flame.get(i).getY() + (64 * f);
				int flameX4 = Arena.flame.get(i).getX();
				int flameY4 = Arena.flame.get(i).getY() - (64 * f);
